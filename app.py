...
# Define Folder And File Path:S3
try:
...
# Loading Environment Variables:S4
try:
...
def chat():
    ...
    try:
        ...
        # Calling Agent with user message:S8
        try:
            ...
            # Extract token usage information:S9
            try:
                ...
                print(f'ERROR - [Main:S9] - Failed To Extract Token Usage: {str(error)}')
            return jsonify({
